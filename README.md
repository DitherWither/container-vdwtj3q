...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-vdwtj3q.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-vdwtj3q.containers.anotherwebservice.com/
...
```
git clone git@github.com:DitherWither/container-vdwtj3q.git
cd container-vdwtj3q
```
...
```
docker attach container-vdwtj3q
```
